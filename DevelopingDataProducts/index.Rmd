...
```{r echo =T, error = F, fig.width=10, fig.height=6,warning=F,tidy=T,R.options='width=100'}
# Plot NumberOfScheduledTrains vs NumberOfLateTrainsOnArrival; facet and color by year  
ggplot(dataset,  
  aes_string("NumberOfScheduledTrains","NumberOfLateTrainsOnArrival"))+geom_point()+   
